    ...
    <AdminLayout>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-8 border-b border-border pb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Organize your products into collections.</p>
        </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 font-sans">
              <FormField control={form.control} name="name" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input className="rounded-none border-border" {...field} onChange={(e) => {
                    field.onChange(e);
                    if (!editingCategory) {
